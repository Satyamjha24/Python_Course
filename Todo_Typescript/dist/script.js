...
function displayTodos() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            <p class="text-gray-100 decoration-dashed font-semibold w-2/3 text-wrap capitalize text-lg text-justify font-serif  break-all  p-2 ${(todo === null || todo === void 0 ? void 0 : todo.status) ? 'line-through text-gray-200' : 'normal'} label" for="checkbox-${index}" class="label">${todo.title}</p>
            <p class="mx-2 tracking-wide text-center rounded-lg  flex justify-center align-middle cursor-pointer text-white font-semibold w-28 h-10 my-auto py-1 px-6 text-lg ${!(todo === null || todo === void 0 ? void 0 : todo.status) ? "bg-yellow-500 w-24 " : "bg-green-500 p-3"}">${todo.status ? 'Completed' : 'Pending'}</p>
